...
// Delete
	...
	$news = new News($news_id, rex_config::get("d2u_news", "default_lang"));
	$news->delete();
			...
			<div class="panel-body">
				...
				<?php
					foreach(rex_clang::getAll() as $rex_clang) {
						...
						$required = $rex_clang->getId() == rex_config::get("d2u_news", "default_lang") ? TRUE : FALSE;
				...
				?>
					<fieldset>
						...
						<div class="panel-body-wrapper slide">
							<?php
								if($rex_clang->getId() != rex_config::get("d2u_news", "default_lang")) {
				...
				<fieldset>
					...
					<div class="panel-body-wrapper slide">
						<?php
							...
							$news = new News($entry_id, rex_config::get("d2u_news", "default_lang"));
							$readonly = TRUE;
							...
							if(rex_addon::get('d2u_machinery')->isAvailable() && count(Machine::getAll(rex_config::get("d2u_news", "default_lang"), TRUE)) > 0) {
								$options_link_type = [];
								...
								$options_machines = [];
								foreach(Machine::getAll(rex_config::get("d2u_news", "default_lang"), TRUE) as $machine) {
						...
						<?php
							...
							d2u_addon_backend_helper::form_linkfield('d2u_news_article', '1', $news->article_id, $this->getConfig('default_lang'));
